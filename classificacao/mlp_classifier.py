...
def main():
    ...
    svm1 = trainMLP(trainFeatures,trainEncodedLabels)
    ...
    svm2 = trainMLP(trainFeatures,trainEncodedLabels)
    ...
    predictedLabels1 = predictMLP(svm1,testFeatures)
    ...
    predictedLabels2 = predictMLP(svm2,testFeatures)
    elapsedTime = round(time.time() - mainStartTime,2)
    print(f'[INFO] Code execution time: {elapsedTime}s')
    accuracy1 = plotConfusionMatrix(encoderClasses1,testEncodedLabels1,predictedLabels1, namefile='HuMoments_mlp')
    accuracy2 = plotConfusionMatrix(encoderClasses2,testEncodedLabels2,predictedLabels2, namefile='LBP_mlp')
