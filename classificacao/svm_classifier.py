...
def main():
    ...
    svm1 = trainSVM(trainFeatures,trainEncodedLabels)
    ...
    svm2 = trainSVM(trainFeatures,trainEncodedLabels)
    ...
    predictedLabels1 = predictSVM(svm1,testFeatures)
    ...
    predictedLabels2 = predictSVM(svm2,testFeatures)
    elapsedTime = round(time.time() - mainStartTime,2)
    print(f'[INFO] Code execution time: {elapsedTime}s')
    accuracy1 = plotConfusionMatrix(encoderClasses1,testEncodedLabels1,predictedLabels1, namefile='HuMoments_svm')
    accuracy2 = plotConfusionMatrix(encoderClasses2,testEncodedLabels2,predictedLabels2, namefile='LBP_svm')
